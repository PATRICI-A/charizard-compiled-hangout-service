...
/**
 * DTO de solicitud para enviar invitaciones masivas a un parche privado.
 * Permite invitar hasta 10 estudiantes en una sola llamada.
 */
@Data
public class SendInvitationRequest {
    /** Lista de IDs de estudiantes a invitar (máx. 10) */
